<main class="user-main w1 ac gradient">
  <section class="user-section con">
    <a href="/" class="logo round abs user-form-logo"><h1>FakeBook</h1></a>
    <h1 class="form-title abs">sign up</h1>
    <form action="/registerCtrl" method="post" class="fc user-input-container">
      ...
      <button type="submit" class="btn abs">sign up</button>
    </form>
  </section>
</main>